...
"[project]/utils/models/User.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/admin/customers/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/models/User.ts [app-route] (ecmascript)");
...
async function GET(req) {
    ...
    if (!token || token.role !== 'admin') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Unauthorized from customer route'
        }, {
            status: 401
        });
    }
    ...
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find();
        const customerData = await Promise.all(users.map(async (user)=>{
            const orderCount = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                userId: user._id
            });
            return {
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$types$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serializeUser"])(user),
                orderCount
            };
        }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(customerData);
    } catch (error) {
        console.error(error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__decaa867._.js.map