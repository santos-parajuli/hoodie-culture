...
async function GET(req, context) {
    ...
    try {
        const category = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Category$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).populate('parentId');
        if (!category) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PUT(req, context) {
    ...
    try {
        ...
        const updatedCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Category$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            name,
            slug,
...
async function DELETE(req, context) {
    ...
    const { id } = await context.params;
    try {
        const categoryToDelete = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Category$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!categoryToDelete) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Category not found'
            }, {
        ...
        if (categoryToDelete.image?.public_id) {
            const cloudinaryDeleteRes = await fetch(`${req.nextUrl.origin}/api/cloudinary/delete`, {
                ...
                body: JSON.stringify({
                    public_id: categoryToDelete.image.public_id
                }),
                credentials: 'include'
            });
        ...
        const deletedCategory = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Category$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!deletedCategory) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Category not found after deletion attempt'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__754a1918._.js.map