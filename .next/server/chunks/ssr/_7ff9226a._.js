...
function CheckoutPage() {
    ...
    const handleCheckout = async (e)=>{
        ...
        if (!session?.user?.id) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Please log in to proceed with checkout.');
            setLoading(false);
            return;
        }
        try {
            const newOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OrderAPI"].createOrder({
                items: cartItems,
                shippingAddress,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(err instanceof Error ? err.message : 'Problem Placing order..');
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=_7ff9226a._.js.map