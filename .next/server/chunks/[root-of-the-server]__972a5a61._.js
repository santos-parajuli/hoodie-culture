...
async function GET(req) {
    ...
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).populate({
            path: 'categoryIds',
            model: __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Category$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$types$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serializeProducts"])(products));
    } catch (error) {
        console.error(error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function POST(req) {
    ...
    try {
        ...
        const stock = variants?.reduce((sum, v)=>sum + v.sizes.reduce((s, size)=>s + (size.stock || 0), 0), 0) ?? 0;
        // ensure slug is unique
        const existingProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        });
        if (existingProduct) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const newProduct = new __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            title,
            slug,
            description,
            price,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$types$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serializeProduct"])(newProduct), {
            status: 201
        });
    } catch (error) {
        console.error(error);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__972a5a61._.js.map