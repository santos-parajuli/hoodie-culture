...
async function GET(req) {
    ...
    try {
        ...
        const excludeProductCondition = {
            title: {
                $ne: 'Customized Hoodie'
            }
        };
        if (search) {
        ...
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort(sortOption).skip(skip).limit(limit).populate({
            path: 'categoryIds',
        ...
        const totalProducts = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$models$2f$Product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(query);
        const serialized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$types$2f$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serializeProducts"])(products);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56d818ab._.js.map