...
function OrdersPage() {
    ...
    const fetchOrders = async ()=>{
        try {
            ...
            if (!res.ok) throw new Error("Error: ".concat(res.status, " ").concat(res.statusText));
    ...
    const handleStatusChange = async (orderId, newStatus)=>{
        try {
            const res = await fetch("/api/admin/orders/".concat(orderId), {
                method: 'PUT',
                headers: {
    ...
    const filteredOrders = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
        "OrdersPage.useMemo[filteredOrders]": ()=>{
            return statusFilter === 'all' ? orders : orders.filter({
                "OrdersPage.useMemo[filteredOrders]": (order)=>order.status === statusFilter
            }["OrdersPage.useMemo[filteredOrders]"]);
        }
    }["OrdersPage.useMemo[filteredOrders]"], [
        orders,
    ...
    const columns = [
        {
            ...
            cell: (param)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/admin/orders/".concat(row.original.id),
        ...
        },
        {
            ...
            cell: (param)=>{
                let { row } = param;
                return "".concat(row.original.userId.name, " (").concat(row.original.userId.email, ")");
            },
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                        ...
                        value: (_ref = (_table_getColumn = table.getColumn('userId')) === null || _table_getColumn === void 0 ? void 0 : _table_getColumn.getFilterValue()) !== null && _ref !== void 0 ? _ref : '',
                        onChange: (e)=>{
                            var _table_getColumn;
                            return (_table_getColumn = table.getColumn('userId')) === null || _table_getColumn === void 0 ? void 0 : _table_getColumn.setFilterValue(e.target.value);
                        },
                        className: "max-w-sm"
                    }, void 0, false, {
                        fileName: "[project]/app/admin/orders/page.tsx",
...
_s(OrdersPage, "y37eQ88gChh42OO529fe8iIfW6Y=", false, function() {
    return [
...
//# sourceMappingURL=_608afe99._.js.map