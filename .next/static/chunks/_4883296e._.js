...
function CheckoutPage() {
    ...
    const cartItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "CheckoutPage.useAppStore[cartItems]": (state)=>state.cartItems
    }["CheckoutPage.useAppStore[cartItems]"]);
    const getCartTotal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "CheckoutPage.useAppStore[getCartTotal]": (state)=>state.getCartTotal
    }["CheckoutPage.useAppStore[getCartTotal]"]);
    const clearCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])({
        "CheckoutPage.useAppStore[clearCart]": (state)=>state.clearCart
    }["CheckoutPage.useAppStore[clearCart]"]);
    ...
    const handleCheckout = async (e)=>{
        ...
        if (!(session === null || session === void 0 ? void 0 : (_session_user = session.user) === null || _session_user === void 0 ? void 0 : _session_user.id)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please log in to proceed with checkout.');
            setLoading(false);
            return;
        }
        try {
            const newOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OrderAPI"].createOrder({
                items: cartItems,
                shippingAddress,
            ...
            clearCart();
            router.push("/order/".concat(newOrder === null || newOrder === void 0 ? void 0 : newOrder.id));
        } catch (err) {
            console.log(err instanceof Error, JSON.stringify(err));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err instanceof Error ? err.message : 'Problem Placing order..');
        } finally{
            setLoading(false);
        }
    };
...
_s(CheckoutPage, "YuI6aee9mqTGTf/qhgaYBx/5Ob0=", false, function() {
    return [
...
//# sourceMappingURL=_4883296e._.js.map