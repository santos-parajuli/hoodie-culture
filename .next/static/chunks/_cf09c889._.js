...
const ProductsAPI = {
    getProducts: (options)=>{
        ...
        if (options === null || options === void 0 ? void 0 : options.limit) params.append('limit', options.limit.toString());
        if (options === null || options === void 0 ? void 0 : options.skip) params.append('skip', options.skip.toString());
        if (options === null || options === void 0 ? void 0 : options.sort) params.append('sort', options.sort);
        if (options === null || options === void 0 ? void 0 : options.categoryId) params.append('categoryId', options.categoryId);
        if (options === null || options === void 0 ? void 0 : options.search) params.append('search', options.search);
        if ((options === null || options === void 0 ? void 0 : options.minPrice) !== undefined) params.append('minPrice', options.minPrice.toString());
        if ((options === null || options === void 0 ? void 0 : options.maxPrice) !== undefined) params.append('maxPrice', options.maxPrice.toString());
        if ((options === null || options === void 0 ? void 0 : options.minRating) !== undefined) params.append('minRating', options.minRating.toString());
        return apiClient("/api/products?".concat(params.toString()), {
            method: 'GET'
        });
    },
    getProduct: (options)=>{
        return apiClient("/api/products/".concat(options === null || options === void 0 ? void 0 : options.slug), {
            method: 'GET'
        });
    }
};
const OrderAPI = {
    ...
    getOrder: (id)=>apiClient("/api/orders/".concat(id), {
            method: 'GET'
        }),
    getUserOrders: (userId)=>apiClient("/api/orders/user/".concat(userId), {
            method: 'GET'
        })
};
const AdminAPI = {
    ...
    getProduct: (id)=>apiClient("/api/admin/products/".concat(id), {
            method: 'GET'
        }),
    deleteProduct: (id)=>apiClient("/api/admin/products/".concat(id), {
            method: 'DELETE'
        }),
    ...
    updateProduct: (id, data)=>apiClient("/api/admin/products/".concat(id), {
            method: 'PUT',
            body: JSON.stringify(data),
            headers: {
                'Content-Type': 'application/json'
    ...
    getCategory: (id)=>apiClient("/api/admin/categories/".concat(id), {
            method: 'GET'
        }),
    ...
    updateCategory: (id, data)=>apiClient("/api/admin/categories/".concat(id), {
            method: 'PUT',
            body: JSON.stringify(data),
            headers: {
                'Content-Type': 'application/json'
    ...
    deleteCategory: (id)=>apiClient("/api/admin/categories/".concat(id), {
            method: 'DELETE'
        }),
...
function ImageUpload(param) {
    let { onUpload, initialImages = [], maxFiles = 3 } = param;
    _s();
    const [uploading, setUploading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [uploadedImages, setUploadedImages] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialImages);
    ...
    const handleFileChange = async (e)=>{
        ...
        for (const file of filesToUpload){
            try {
                ...
                formData.append('api_key', ("TURBOPACK compile-time value", "641442559225149"));
                formData.append('timestamp', timestamp);
                formData.append('signature', signature);
                const xhr = new XMLHttpRequest();
                xhr.open('POST', "https://api.cloudinary.com/v1_1/".concat(("TURBOPACK compile-time value", "instagramcloneinawish"), "/image/upload"), true);
    ...
    const handleRemoveImage = async (public_id)=>{
        ...
        const updatedImages = uploadedImages.filter((img)=>img.public_id !== public_id).map((img)=>({
                ...img
            }));
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ...
                        disabled: uploading || isAtMaxFiles
                    }, void 0, false, {
                        fileName: "[project]/components/shared/ImageUpload.tsx",
                        lineNumber: 111,
                        columnNumber: 5
            ...
            Object.entries(progress).map((param)=>{
                let [fileName, p] = param;
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "mt-2",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: uploadedImages.map((image)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                onClick: ()=>handleRemoveImage(image.public_id ? image.public_id : ''),
                                children: "X"
                            }, void 0, false, {
                                fileName: "[project]/components/shared/ImageUpload.tsx",
                                lineNumber: 128,
...
_s(ImageUpload, "HhUPDbFfq9AW+eUWtbditBzFonI=");
_c = ImageUpload;
var _c;
...
function MultiSelect(param) {
    let { options, value, onChange, placeholder } = param;
    var _options_find;
    _s();
        ...
        children: [
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    children: [
                                        ...
                                        value.length === 1 && ((_options_find = options.find((opt)=>opt.value === value[0])) === null || _options_find === void 0 ? void 0 : _options_find.label),
                                        value.length === 2 && value.map((v)=>{
                                            var _options_find;
                                            return (_options_find = options.find((opt)=>opt.value === v)) === null || _options_find === void 0 ? void 0 : _options_find.label;
                                        }).join(', '),
                                        value.length > 2 && "".concat(value.length, " selected")
                                    ]
                                }, void 0, true, {
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$command$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommandItem"], {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('mr-2 h-4 w-4', isActive ? 'opacity-100' : 'opacity-0')
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/ui/multi-select.tsx",
                                                        lineNumber: 59,
                                                        columnNumber: 12
            ...
            value.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: value.map((val)=>{
                    var _options_find;
                    const label = (_options_find = options.find((opt)=>opt.value === val)) === null || _options_find === void 0 ? void 0 : _options_find.label;
...
function UploadProductPage() {
    ...
    const [manualSlug, setManualSlug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [aboutItem, setAboutItem] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UploadProductPage.useEffect": ()=>{
            const fetchCategories = {
                "UploadProductPage.useEffect.fetchCategories": async ()=>{
                    try {
                        const cats = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CategoryAPI"].getCategories();
                        setCategories(cats);
                    } catch (err) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(err instanceof Error ? err.message : 'Unknown error');
                    } finally{
                        setLoading(false);
                    }
                }
            }["UploadProductPage.useEffect.fetchCategories"];
            fetchCategories();
        }
    }["UploadProductPage.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
    ...
    const handleImageUpload = (uploaded)=>setImages(uploaded);
    const handleVariantImageUpload = (index, uploaded)=>{
        const newVariants = [
            ...variants
        ];
    ...
    const handleSizeToggle = (variantIndex, sizeLabel, checked)=>{
        const newVariants = [
            ...variants
        ];
        const variant = newVariants[variantIndex];
        if (checked) variant.sizes.push({
            label: sizeLabel,
            stock: 0
        });
    ...
    const handleSizeStockChange = (variantIndex, sizeLabel, stock)=>{
        const newVariants = [
            ...variants
        ];
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AdminAPI"].createProduct({
                title,
                slug,
                description,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
        className: "w-full rounded-none p-2 md:p-5 mx-auto",
        children: [
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$ImageUpload$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                                initialImages: variant.image.url ? [
                                                                    variant.image
                                                                ] : [],
                                                                onUpload: (imgs)=>handleVariantImageUpload(index, imgs),
                                                                maxFiles: 1
                                                            }, void 0, false, {
                                                                fileName: "[project]/app/admin/products/create/page.tsx",
                                                                lineNumber: 179,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: AVAILABLE_SIZES.map((sizeLabel)=>{
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$checkbox$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Checkbox"], {
                                                                                checked: isSelected,
                                                                                onCheckedChange: (val)=>handleSizeToggle(index, sizeLabel, val)
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/admin/products/create/page.tsx",
                                                                                lineNumber: 188,
                                                                                columnNumber: 16
                                                                    ...
                                                                    isSelected && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Input"], {
                                                                                type: "number",
                                                                                value: (_selectedSize_stock = selectedSize === null || selectedSize === void 0 ? void 0 : selectedSize.stock) !== null && _selectedSize_stock !== void 0 ? _selectedSize_stock : 0,
                                                                                onChange: (e)=>handleSizeStockChange(index, sizeLabel, parseInt(e.target.value)),
                                                                                min: 0
                                                                            }, void 0, false, {
                                                                                fileName: "[project]/app/admin/products/create/page.tsx",
                                                                                lineNumber: 194,
...
_s(UploadProductPage, "eCn2RKzxW/PrfactrH3KQAeh+Cc=", false, function() {
    return [
...
//# sourceMappingURL=_cf09c889._.js.map