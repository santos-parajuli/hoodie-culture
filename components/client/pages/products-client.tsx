...
interface ProductsClientProps {
	initialCategory?: string | string[] | undefined;
}
...
export default function ProductsClient({ initialCategory = '' }: ProductsClientProps) {
	...
	const [selectedCategory, setSelectedCategory] = useState<string>(typeof initialCategory === 'string' ? initialCategory : '');
	...
	const fetchProducts = useCallback(
		async (reset = false, customSkip = 0) => {
			setLoading(true);
			setError(null);
			try {
